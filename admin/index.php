...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistem Informasi Kenaikan Jabatan</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-mini"><b>SI</b> KJ</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Sistem Informasi&nbsp;</b> Kenaikan Jabatan</span>
        </a>
      ...
      <div style="background:url(../images/0.png)repeat;" class="content-wrapper">
        ...
        <section  class="content-header">
          <h1> Sistem Informasi Kenaikan Jabatan
            <small>PT. Adira Dinamika Multifinance</small>
          </h1>
          <ol class="breadcrumb">
	...
	<?php include "isi.php";?>        		
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Informasi Kenaikan Jabatan PT. Adira Dinamika Multifinance <b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2019 <a href="https://adira.co.id/">PT Adira Dinamika Multi Finance</a>.</strong> All rights reserved.

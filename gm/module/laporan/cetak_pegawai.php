...
?>
          ...
          <section class="content">
			...
			<h3><img src="inc/logo_adira.png"/></h3>
			<b>Ruko Permata Metropolitan Blok A3 No 31-33,34 Jl.Sultan Hasanudin<br/>
			Tambun Bekasi,Jawa Barat</b>
			</div><br/>
            ...
            <div class="box box-default">
              <div class="box-header with-border">
				...
				Bekasi, <?php echo Indonesia2Tgl(date('Y-m-d'));?> 
				</span>					
              </div>
              <div class="box-body">
